...
3. Download the [repository](https://github.com/PieritoAlva95/acme-salary-calculator-ioet) or use the command in your terminal.
   `git clone https://github.com/PieritoAlva95/acme-salary-calculator-ioet`
